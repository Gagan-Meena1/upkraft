            ...
            <div className='row'>
                <div className='col-lg-4 col-md-5'>
                    <div className='exclusive-left-text'>
                        ...
                        <p className='line' style={{ lineHeight: '1.8' }}>Master music faster with our AI Practice Studio delivering real-time feedback, guided by expert tutors aligned to your style and goals. Track measurable progress every week, practice the songs you truly love, and keep parents engaged with family-friendly features that celebrate every milestone.</p>
