...
interface Props {
 ...
 onDeleteRequest?: (entry: AssignmentHistory) => void;
}
...
<div className="mt-2 flex items-center gap-2">
  ...
  {onDeleteRequest && (
    <button
      onClick={() => {
        if (confirm("Are you sure you want to request deletion of this package?")) {
          onDeleteRequest(entry);
        }
      }}
      className="text-xs text-red-600 border border-red-300 rounded-lg px-3 py-1.5 hover:bg-red-50 transition-colors flex items-center gap-1"
