                        ...
                        <div className='personal-details card-box'>
                            ...
                            <ul className='details-list-personal p-0 m-0 list-unstyled'>
                                ...
                                <li className='d-flex align-items-center'>
                                    ...
                                    <span className='details-box'>22</span>
                                </li>
                                <li className='d-flex align-items-center'>
                        ...
                        <div className='personal-details card-box'>
                            ...
                            <ul className='details-list-personal p-0 m-0 list-unstyled'>
                                <li className='d-flex align-items-center'>
                                    ...
                                    <span className='details-box'>Piano Classes & Guitar Classes</span>
                                </li>
                                <li className='d-flex align-items-center'>
                                        ...
                                        <div className='right-assignment my-course-student-right mt-xxl-0 mt-3'>
                                            <div className='student-assignment my-course-student d-flex align-items-center flex-wrap gap-xl-4 gap-2'>
                                                <ul className='d-flex align-items-center w-full-width gap-2 list-unstyled flex-wrap m-0 p-0'>
                                                    <li>
                                                        <Link href="/overall-performance" className='btn btn-primary d-flex align-items-center justify-content-center gap-2'>
                                                    ...
                                                    <li>
                                                        <Link href="/session-summary" className='btn btn-border padding-fixed d-flex align-items-center justify-content-center gap-2'>
            ...
            <div className='col-xl-3 col-md-12'>
                <div className='student-profile-right-box'>
                    ...
                    <div className='card-box'>
                        ...
                        <ScoreCard title="Class Quality Score" score={5.6} text="Excellent" image={StudentProfileImg}/>                       
                        <ScoreCard title="Assignments" score={5} text="Completed"  image={StudentProfileImg}/> 
                        </div>
                    </div>
                </div>
            </div>
