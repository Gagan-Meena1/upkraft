        ...
        <div className='text-bottom-box'>
            <div className='blue-box'>
                ...
                <Link href="/student/refer-earn" className='btn btn-orange w-100 d-flex align-items-center gap-2 justify-content-center text-center'>
                    <span>Refer Now</span>
                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.5 12H21" stroke="#1E1E1E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M14.5 19L21.5 12L14.5 5" stroke="#1E1E1E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </Link>
            </div>
        </div>
    </div>
...
export default StudentReferAndEarn
