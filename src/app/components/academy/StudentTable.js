      ...
      <div className="assignments-list-sec">
        <div className="head-com-sec justify-content-end d-flex align-items-center mb-4 gap-3 flex-xl-nowrap flex-wrap">
          {/* <div className="left-head">
            <h2 className="m-0">Top Student Performing</h2>
          </div> */}
                    ...
                    <div className='right-head d-flex align-items-center gap-2 flex-md-nowrap flex-wrap'>
                        ...
                        <div className='select-box'>
                            <Form.Select aria-label="Default select example">
                                ...
                                <option value="4">Drums Intermediate</option>
                            </Form.Select>
                        </div>
                        <div className='select-box'>
                            <Form.Select aria-label="Default select example">
              ...
              <table className="table align-middle m-0 w-1200">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                        <div className="text-box-progress d-flex align-items-center gap-2">
                            <span className="lighter-blue">84%</span>
                            <div className="left-box">
                                <span className="d-block">12/15 lessons</span>
                    ...
                    <td>92%</td>
                    <td>Oct 28, 2025</td>
                    <td><span className="lighter-blue">Active</span></td>
                    {/* <td>
                      <span className="text-orange">● Low</span>
                    </td> */}
                  ...
                  <tr>
                    ...
                    <td>
                        <div className="text-box-progress d-flex align-items-center gap-2">
                            <span className="lighter-orange">55%</span>
                            <div className="left-box">
                                <span className="d-block">8/15 lessons</span>
                                <ProgressBar variant="" className="progress-orange" now={55} />
                            </div>
                        </div>
                    </td>
                    <td>92%</td>
                  ...
                  <tr>
                    ...
                    <td>
                        <div className="text-box-progress d-flex align-items-center gap-2">
                            <span className="lighter-red">48%</span>
                            <div className="left-box">
                                <span className="d-block">8/15 lessons</span>
                                <ProgressBar variant="" className="progress-red" now={48} />
                            </div>
                        </div>
                    </td>
                    <td>92%</td>
                    <td>Oct 28, 2025</td>
                    <td><span className="lighter-red">Trial</span></td>
                    {/* <td>
