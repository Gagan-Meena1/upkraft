...
export default function Home() {
  ...
  return (
    <div className="!min-h-screen !w-full !bg-gray-50 !flex !flex-col !text-gray-900" style={{ backgroundColor: '#fbf5ee' }}>
      ...
      {/* Features Section */}
      <div className="!w-full !flex !flex-col !items-center !bg-white !py-12 sm:!py-16 lg:!py-24 !px-4 sm:!px-6 lg:!px-8 !relative !overflow-hidden" style={{ backgroundColor: '#fbf5ee !important' }}>
        {/* Content */}
