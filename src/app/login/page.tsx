    ...
    <>
      ...
      <div className="!flex !items-center !justify-center !min-h-screen !bg-gray-100">
        ...
        <div className="!bg-white !p-8 !rounded-lg !shadow-lg !w-full !max-w-md">
          <h1 className="!text-3xl !font-bold !text-[#5204d6] !mb-2">{loading ? "Processing..." : "Login"}</h1>
          ...
          <button
            onClick={onLogin}
            className={`!w-full !py-3 !rounded-md !font-medium !text-white !transition-all ${loading
                ? "!bg-gray-400 !cursor-not-allowed"
                : "!bg-[#5204d6] !hover:bg-[#6b3fe0]"
              }`}
            disabled={loading}
          >
          ...
          <div className="!mt-6 !flex !justify-between !text-sm">
            <p className="!text-gray-600">
              ...
              <Link href="/signup" className="!text-[#5204d6] !font-medium !hover:text-orange-600">
                Sign Up
              </Link>
            </p>
            <Link href="/forgot-password" className="!text-[#5204d6] !font-medium !hover:text-orange-600">
              Forgot Password?
            </Link>
          </div>
        </div>
