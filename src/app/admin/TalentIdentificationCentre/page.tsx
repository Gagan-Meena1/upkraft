...
import { FileText, Calendar, Clock, ArrowLeft, ChevronRight, AlertCircle, Download } from 'lucide-react';
                ...
                <div key={assignment._id} className="p-6 hover:bg-gray-50 transition-colors duration-150">
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                    <div className="flex-1">
                      <h2 className="text-xl font-semibold text-gray-800 mb-2 group-hover:text-orange-500">{assignment.title}</h2>
                    ...
                    <div className="flex flex-col md:items-end gap-3">
                      ...
                      {/* <button 
                        onClick={() => router.push(`/assignment/${assignment._id}?classId=${classId}&courseId=${courseId}`)}
                        className="flex items-center text-sm font-medium text-orange-500 hover:text-orange-600 transition-colors"
                      >
                        View details
