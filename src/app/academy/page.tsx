...
const Dashboard = () => {
  ...
  const [avgCSATScore, setAvgCSATScore] = useState<number | null>(null);
  const [lastMonthAvgCSATScore, setLastMonthAvgCSATScore] = useState<number | null>(null);
  const [csatPercentageChange, setCsatPercentageChange] = useState<number | null>(null);
  ...
  // CSAT score is already on 0-100 scale from API, so we can use it directly as percentage
  const displayedCSAT = avgCSATScore !== null ? Math.round(avgCSATScore) : null;
        ...
        <div className='card-academy-box mt-4'>
            <div className='row'>
                <div className='col-lg-3 col-6 mb-4'>
                    <Link href="/academy/tutors" className='card-box academy-card d-block'>
                        <div className="icons">
                ...
                <div className='col-lg-3 col-6 mb-4'>
                    <Link href="/academy/students" className='card-box academy-card d-block'>
                        <div className="icons">
                ...
                <div className='col-lg-3 col-6 mb-4'>
                    <Link href="/academy/revenue-management" className='card-box academy-card d-block'>
                        <div className="icons">
                    ...
                    <Link href="" className='card-box academy-card d-block'>
                        ...
                        <span className="badge tag-exam">
                          {isCSATLoading
                            ...
                            : csatError
                            ? "Unable to load stats"
                            : selectedRange === "thisMonth" && csatPercentageChange !== null
                            ? csatPercentageChange >= 0
                              ? `↑ ${csatPercentageChange.toFixed(1)}%`
                              : `↓ ${Math.abs(csatPercentageChange).toFixed(1)}%`
                            : selectedRange === "lastMonth"
                            ? "Last month"
                            : "No data"}
                        </span>
