...
export const HOBBIES = [
  {id:1, emoji:"💃", name:"Classical Dance",    cat:"Performing Arts", tutors:2, rating:"4.8", age:"5–14 yrs", desc:"Bharatanatyam & Kathak with certified instructors. Build grace, rhythm and cultural connect.", slots:14, new:true,  hot:false, col:["#1a0d2e","#2a1040"]},
  {id:2, emoji:"🎸", name:"Guitar",             cat:"Music",           tutors:1, rating:"4.6", age:"8+ yrs",   desc:"Western & Carnatic guitar from beginner to advanced. Learn theory, chords and solos.",            slots:9,  new:false, hot:false, col:["#0d1a0d","#142214"]},
  ...
  {id:4, emoji:"🎨", name:"Sketching & Drawing",cat:"Visual Arts",     tutors:1, rating:"4.5", age:"6+ yrs",   desc:"Pencil sketching, charcoal art, cartooning & watercolour basics with a seasoned artist.",        slots:7,  new:false, hot:false, col:["#2e1a0d","#3a2210"]},
  {id:5, emoji:"🥋", name:"Karate",             cat:"Fitness",         tutors:1, rating:"4.7", age:"5–16 yrs", desc:"Shotokan karate from a certified black belt. Discipline, focus and fitness all in one class.",    slots:11, new:false, hot:false, col:["#1a0d0d","#2a1515"]},
  {id:6, emoji:"🎹", name:"Keyboard & Piano",   cat:"Music",           tutors:1, rating:"4.6", age:"6+ yrs",   desc:"Western classical and Bollywood film music on keyboard. All beginners welcome.",                  slots:6,  new:false, hot:false, col:["#0d0d2e","#101035"]},
  {id:7, emoji:"🎭", name:"Theatre & Drama",    cat:"Performing Arts", tutors:1, rating:"4.7", age:"8–16 yrs", desc:"Improv, scripted drama and stage confidence workshops. Builds communication and creativity.",     slots:8,  new:false, hot:true,  col:["#1a1a0d","#252510"]},
  {id:8, emoji:"📸", name:"Photography",        cat:"Visual Arts",     tutors:1, rating:"4.5", age:"12+ yrs",  desc:"DSLR & mobile photography basics, composition rules, and light editing techniques.",              slots:5,  new:false, hot:false, col:["#0a1520","#0e1e2a"]},
  {id:9, emoji:"🇫🇷",name:"French Language",   cat:"Language",        tutors:1, rating:"4.6", age:"10+ yrs",  desc:"Conversational French from A1 level. Great for travel, academics and culture.",                   slots:10, new:false, hot:false, col:["#0d1a2e","#111f35"]},
];
