      ...
      <div className="max-w-6xl mx-auto">
        ...
        {qualityData && !loading && (!qualityData.overall_quality_score && qualityMetrics.filter(m => m.score !== undefined && m.score !== null).length === 0) && (
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <button
              onClick={fetchClassQuality}
              className="mt-6 px-6 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-medium transition-colors shadow-md flex items-center space-x-2 mx-auto"
            >
