      ...
      <div className='row'>
        ...
        <div className='col-xxl-3 col-md-6 mb-4 order-xxl-2 order-md-3'>
            <div className='profile-attended-box card-box'>
              <ProfileAttended classesAttended={completedClasses} lessonsCompleted={totalAssignments - incompleteAssignmentCount} />
            </div>
        </div>
                ...
                <div className='video-box'>
                    ...
                    {!isPlaying ? (
                        <div className="poster-wrapper position-relative">
                            <img src={VideoPoster} alt="Video Poster" className="img-fluid rounded shadow"/>
                            <button variant="light" className="play-btn position-absolute top-50 start-50 translate-middle rounded-circle p-3 shadow" onClick={() => setIsPlaying(true)} > ▶ </button>
                        </div>
                    ) : (
        ...
        <div className='col-xxl-3 col-md-6 mb-4'>
          <div className='card-box'>
            <div className='top-progress mb-4'>
                <SemiCircleProgress value={7.6} label="Class Quality Score" />
            </div>
            <div className='bottom-progress'>
                <SemiCircleProgress value={studentPerformance} label="Overall Student Performance" />
            </div>
          </div>
        </div>
        <div className='col-xxl-3 col-md-6 mb-4'>
