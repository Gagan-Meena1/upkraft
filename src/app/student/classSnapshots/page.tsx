...
import { Play, Video, BookOpen, Calendar, Clock, Star, Download } from 'lucide-react';
...
const LoadingSpinner = () => (
  <div className="flex items-center justify-center h-screen bg-gradient-to-br from-gray-50 to-white">
    <div className="text-2xl font-light text-gray-800">Loading class snapshots...</div>
  </div>
);
...
// Main Component
const ClassSnapshotsPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setError("Failed to fetch class snapshots data");
        toast.error("Failed to load class snapshots");
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Class Snapshots</h1>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        {classData.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No class recordings available</h3>
...
export default ClassSnapshotsPage;
