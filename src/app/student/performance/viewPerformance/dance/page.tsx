    ...
    return (
      <div className="min-h-screen bg-gray-50 flex justify-center items-center">
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <div className="text-orange-500 text-xl">Loading your dance performance data...</div>
        </div>
      </div>
    );
  }
        ...
        <div className="bg-white rounded-lg shadow-md p-8 max-w-lg w-full text-center">
          <div className="mb-6">
            ...
            <p className="text-gray-600 mb-6">
              No feedback is available for this course yet. Your dance performance metrics will appear here after your first class evaluation.
            </p>
          </div>
          <button
            onClick={() => router.push(`/student/courses?studentId=${studentId}`)}
      ...
      <div className="bg-white border-b border-gray-200 w-full">
        <div className="px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-semibold text-gray-800">Dance Performance Dashboard</h1>
          </div>
        </div>
      </div>
