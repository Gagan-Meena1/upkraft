  ...
  return (
    <div className="h-full flex flex-col overflow-y-auto p-8">
        ...
        <div className="grid grid-cols-12 gap-6">
          <div className="border border-[#0152A7] rounded-2xl p-6 flex flex-col items-center text-center col-span-3 bg-[#FFFFFF]">
          ...
          {/* Personal Details */}
          <div className="bg-white rounded-2xl shadow-sm border p-8 col-span-3">
        ...
        {/*  Details */}
<div className="lg:col-span-3 p-8 rounded-xl mt-8 space-y-6">
  <div className="grid grid-cols-12 gap-6">
    
    {/* LEFT SIDE */}
    <div className="col-span-7 bg-white p-8 rounded-l-xl shadow-sm -ml-8">
      ...
      <div className="col-span-2  bg-white p-4 rounded-r-xl shadow-sm -ml-6">
      {/* Latest Class Highlight */}
      <div className="col-span-12 lg:col-span-4 flex flex-col items-center justify-between gap-6 mt-25">
        ...
        <div className="relative rounded-lg overflow-hidden">
          <img
            ...
            alt="Piano lesson"
            className="w-59 h-40 object-cover"
          />
    ...
    {/* RIGHT SIDE */}
    <div className="col-span-3 flex flex-col space-y-6 ml-4">
      {/* Class Quality Score */}
      <div className="flex flex-col items-center bg-white p-4 rounded-lg shadow-sm gap-4">
        <h3 className="text-[16px] font-semibold text-[#212121] mb-4">
          Class Quality Score
        </h3>
        <div className="relative w-58 h-58 -mt-2">
          <svg
      ...
      {/* Assignments */}
        ...
        <div className="relative w-58 h-58 -mt-4">
          <svg
            className="w-full h-full rotate-[-90deg]"
            viewBox="0 0 160 160"
          >
