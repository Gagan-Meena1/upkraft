        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-lg p-16 text-center max-w-2xl mx-auto">
            ...
            <button
              ...
              disabled={loading}
              className="bg-purple-600 hover:bg-purple-700 disabled:bg-gray-400 text-white rounded-lg py-3 px-6 font-medium transition-colors inline-flex items-center gap-2 mx-auto"
            >
