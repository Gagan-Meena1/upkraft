...
export default function Dashboard() {
  ...
  const handleJoinMeeting = async (classId: string) => {
    try {
      ...
      // Instead of setting meeting state, redirect href video call page
      router.push(
          ...
          <div className="col-xxl-4 col-md-12 order-xxl-2 order-sm-2 order-md-3 mb-4">
            <div className="details-student-box">
              <div className="row">
                ...
                <div className="col-md-12 mb-4">
                  <div className="card-box">
                    <h2 className="top-text">80%</h2>
                    <p className="bottom-text">Tutor CSAT Score</p>
                  </div>
                </div>
                {/* <div className='col-md-6 mb-4'>
                  ...
                  <div className='col-md-6 mb-md-0 mb-4'>
                      <div className='card-box'>
                        <h2 className='top-text'>15%</h2>
                        <p className='bottom-text'>Assignment Completion Rate</p>
                      </div>
                  </div>
                  <div className='col-md-6 mb-md-0 mb-4'>
                      <div className='card-box'>
