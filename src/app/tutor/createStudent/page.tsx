            ...
            <div className="bg-gray-50 px-6 py-4">
              <div className="flex justify-between items-center">
                ...
                <Link
                  ...
                  className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-gray-500 bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
                >
                  Return to Dashboard
                </Link>
              </div>
