...
export default function TutorCoursesPage() {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/Api/tutors/courses?courseId=${deleteConfirmation.courseId}`,
        {
          method: "DELETE",
        }
      );
      ...
      if (data.success) {
        ...
        setCourses((prevCourses) =>
          prevCourses.filter(
            (course) => course._id !== deleteConfirmation.courseId
          )
        );
      } else {
  ...
  return (
    <div className="flex overflow-y-auto h-full bg-gray-50">
      <Toaster />
      {/* <Sidebar userType="tutor" /> */}
            ...
            {filteredCourses.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-400 text-sm mt-2">
                  Try selecting a different month or add a new course.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 max-w-md w-full mx-4">
            ...
            <p className="text-gray-600 mb-6">
              ...
              {deleteConfirmation.courseName}"? This action cannot be undone.
            </p>
